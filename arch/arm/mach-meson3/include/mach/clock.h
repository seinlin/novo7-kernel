...
typedef int (clk81_note_fn)(struct clk81_client* client);

struct clk81_client {
	struct list_head list;
	char* name;
	void* param;
	clk81_note_fn* pre_change_fun;
	clk81_note_fn* post_change_fun;
	clk81_note_fn* check_client_ready;
};

extern int regist_clk81_client(char* name, clk81_note_fn* pre_fun, clk81_note_fn* post_fun, 
					clk81_note_fn* check_fun, void* param);
extern int unregist_clk81_client(char* name);
