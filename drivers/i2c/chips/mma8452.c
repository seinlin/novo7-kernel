...
static struct early_suspend g_mma8452_early_suspend;
#endif
...
static void mma8452_early_suspend(struct early_suspend *h)
{
	...
	i2c_smbus_write_byte_data(mma8452_i2c_client, MMA8452_CTRL_REG1,mma_status.ctl_reg1 & 0xFE);
}

static void mma8452_late_resume(struct early_suspend *h)
{
	printk("enter -----> %s \n",__FUNCTION__);
	i2c_smbus_write_byte_data(mma8452_i2c_client, MMA8452_CTRL_REG1, mma_status.ctl_reg1);
}
#endif
				   ...
				   const struct i2c_device_id *id)
{
    ...
    g_mma8452_early_suspend.level = EARLY_SUSPEND_LEVEL_BLANK_SCREEN;
    g_mma8452_early_suspend.suspend = mma8452_early_suspend;
    g_mma8452_early_suspend.resume = mma8452_late_resume;
	register_early_suspend(&g_mma8452_early_suspend);
#endif
