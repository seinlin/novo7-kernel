...
static struct v4l2_frmsize_discrete gt2005_prev_resolution[2]=
{
	{352,288},
	{640,480},
};
...
/*	{0x0116 , 0x02},
	...
	*/
	...
	{0x020E , 0xBC},
	{0x020F , 0x08},
	{0x0210 , 0xf0},//e4  f6  20111130  f0 d6
	{0x0211 , 0x00},
	{0x0212 , 0x10},   // 20
	{0x0213 , 0x81},
	{0x0214 , 0x15},
	...
	{0x0268 , 0x9c},//8f r2cr   93
	{0x0269 , 0x92},//a3 g2cr    94
	{0x026A , 0xB0},//b4 b2cb    b2
	{0x026B , 0x90},//90 b2cb   90
...
void GT2005_set_param_wb(struct gt2005_device *dev,enum  camera_wb_flip_e para)//white balance
{
    ...
    switch (para)
	{
		...
		case CAM_WB_AUTO://auto
			...
			i2c_put_byte(client,0x0441 , 0x5f);// 0x4b
			i2c_put_byte(client,0x0442 , 0x00);
			i2c_put_byte(client,0x0443 , 0x00);
			i2c_put_byte(client,0x0444 , 0x2c);
			break;
...
void GT2005_set_param_exposure(struct gt2005_device *dev,enum camera_exposure_e para)
{
    ...
    switch (para)
	{
		...
		case EXPOSURE_0_STEP:
			...
			i2c_put_byte(client,0x0201 , 0x10);//0xf8
			break;
		...
		default:
			i2c_put_byte(client,0x0300 , 0x81);
			i2c_put_byte(client,0x0301 , 0x90);
			i2c_put_byte(client,0x0201 , 0xf8);
			break;
			break;
